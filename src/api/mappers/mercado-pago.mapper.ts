...
import { CriarPagamentoDTO, CriarPagamentoMercadoPagoDTO, CriarPagamentoMercadoPagoResponseDTO } from "../dtos";
...
export class MercadoPagoMapper {
  ...
  paraCriarPagamentoMercadoPagoDTO(criarPagamentoDTO: CriarPagamentoDTO): CriarPagamentoMercadoPagoDTO {
    return {
      ...
      description: this.configService.get<string>('MERCADO_PAGO_DESCRICAO_PAGAMENTO'),
      notification_url: this.configService.get<string>('MERCADO_PAGO_NOTIFICATION_URL'),
      items: [{
